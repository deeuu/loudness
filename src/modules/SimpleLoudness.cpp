...
namespace loudness{
    ...
    SimpleLoudness::SimpleLoudness(
            Real exponent,
            Real cParam,
            bool dioticPresentation) :
        Module("SimpleLoudness"),
        exponent_ (exponent),
        cParam_(cParam),
    ...
    bool SimpleLoudness::initializeInternal(const SignalBank &input)
    {
    ...
    void SimpleLoudness::processInternal(const SignalBank &input)
    {       
    ...
    void SimpleLoudness::resetInternal()
    {
    }
}
